...
<body>
    ...
    <!-- ======= Pertanian Section ======= -->
    <section id="pertanian" class="portfolio-details">
        <div class="container">

            <div class="section-title">
                <h3> <span>DATA PERTANIAN</span></h3>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>{{ $itemPertanian->luas_wilayah_tanam }} m<sup>2</sup></td>
                                    </tr>
                                </table>
                                </p>
                            </div>
